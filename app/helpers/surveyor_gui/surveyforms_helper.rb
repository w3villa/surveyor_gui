  ...
  module SurveyformsHelper
    ...
    def render_questions_and_groups_helper(q, ss)
      ...
      if q.object.part_of_group?
        ...
        render "surveyor_gui/surveyforms/question_wrapper", f: q
      end
    end
    ...
    def row_label_if_question_group(question)
      if question.part_of_group?
        "<span class=\"row_name actual-question\" data-question-id=\"#{question.id}\">#{question.text}</span>".html_safe
      end
    end
    ...
    def _render_initial_group(q, ss)
      if @current_group.nil?
        ...
        render "surveyor_gui/surveyforms/question_group", :ss => ss, :f => q
      end
    end
    ...
    def checkbox_values(answer_id)
      return [answer_id].compact if answer_id.nil? || answer_id.is_a?(Integer)
